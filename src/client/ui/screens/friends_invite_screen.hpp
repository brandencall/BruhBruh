...
//     void RenderFriendRow(const FriendEntry &entry, int x, int y, int rowW, int rowH, bool hovered, bool
//     inviteHovered); void RenderScrollbar(int panelX, int panelY, int panelW, int panelH, int listAreaH, int rowH);
